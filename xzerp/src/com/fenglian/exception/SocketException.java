/******************************************************************************
 * @(#)IOException.java 1.0  2005-6-20
 *
...
public class SocketException extends RuntimeException
{
     ...
     */
    public SocketException(String message,String errorCode)
    {
        super(errorCode);
    ...
    public SocketException( String message,Exception e,String errorCode)
    {
        super(errorCode);
