 ...
 * 
 */
public class ZipCommandFactory {
...
//			response.addHeader("ContentType", "Content-Type: text/html;charset=UTF-8");
	 ...
	 * @throws Exception 
	 */
	private void returnZip(Object obj, HttpServletResponse res) throws Exception {
		String dir = Config.getFileConfig("TEMP_FILE_PATH");
		String source=Msg2Zip.object2Zip(dir, obj);
