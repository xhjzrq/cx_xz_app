...
import com.fenglian.command.ZipCommandFactory;
 ...
 * @author zhang.yb
 */
public class ZipAction extends DispatchAction {
	...
	public ActionForward exe(ActionMapping mapping, ActionForm form,
			...
			throws Exception {
		FileLogger.debug("指令处理ZIP");
		ZipCommandFactory cf = new ZipCommandFactory();
