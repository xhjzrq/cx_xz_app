...
<head>
    ...
    <script type="text/javascript">
    	...
    	function cellStyler(value,row,index){    		
    		var i = (value+"").indexOf('<div');
    		if(i>0){
    			value=(value+"").substring(0,i);
    		}
            if (row[value+"DCOLOR"] ){
                return 'background-color:#'+row[value+"DCOLOR"]+";color:red;";
            }
        }
    			...
    			onClickCell:function(index,field,value){
    				if("LSH"!=field){
    					...
    					if(v.length!=0){
							...
							window.location="m3.jsp?v="+v;
							//$.mobile.go("m3.jsp?v="+v);
    					}
    				}    				
    			}
    			<%if(!ismoblie){%>,
        ...
        <div title="内容列表">
        	<table id="dg" data-options="singleSelect:true,border:false,scrollbarSize:0,rownumbers:true" height="100%">
        		<thead data-options="frozen:true">
		            <tr>
		                <th data-options="field:'LSH',width:70,height:70,align:'center'">序号</th>		                
		            </tr>
		        </thead>
        		<thead>
		            <tr>
		            	<th data-options="field:'H1',width:70,align:'center',styler:cellStyler">H1</th>
		            	<th data-options="field:'H2',width:70,align:'center',styler:cellStyler">H2</th>
		            	<th data-options="field:'G1',width:70,align:'center',styler:cellStyler">G1</th>
		            	<th data-options="field:'G2',width:70,align:'center',styler:cellStyler">G2</th>
		            	<th data-options="field:'F1',width:70,align:'center',styler:cellStyler">F1</th>
		            	<th data-options="field:'F2',width:70,align:'center',styler:cellStyler">F2</th>
		            	<th data-options="field:'E1',width:70,align:'center',styler:cellStyler">E1</th>
		            	<th data-options="field:'E2',width:70,align:'center',styler:cellStyler">E2</th>
		            	<th data-options="field:'D1',width:70,align:'center',styler:cellStyler">D1</th>
		            	<th data-options="field:'D2',width:70,align:'center',styler:cellStyler">D2</th>
		            	<th data-options="field:'C1',width:70,align:'center',styler:cellStyler">C1</th>
		            	<th data-options="field:'C2',width:70,align:'center',styler:cellStyler">C2</th>
		            	<th data-options="field:'B1',width:70,align:'center',styler:cellStyler">B1</th>
		            	<th data-options="field:'B2',width:70,align:'center',styler:cellStyler">B2</th>
		            	<th data-options="field:'A1',width:70,align:'center',styler:cellStyler">A1</th>
		            	<th data-options="field:'A2',width:70,align:'center',styler:cellStyler">A2</th>
		            </tr>
		        </thead>
        	</table>            
        </div>
