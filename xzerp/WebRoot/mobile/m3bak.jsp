...
<head>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function () {
    		...
    		$('#dg').datagrid({url:'../jsonAction.do?method=exe&CMD=M1',queryParams:{kwh:'<%=v%>'},pageSize:20});
        	...
        	<table id="dg" data-options="singleSelect:true,border:false,scrollbarSize:18,rownumbers:true,pagination:true,pagePosition:'top'" height="100%">  
		        ...
		        <thead>
		            <tr>
		                ...
		                <th data-options="field:'KHFL',width:100,align:'center'">客户分类</th>
		                <th data-options="field:'WPFLM',width:100,align:'center'">物资类别</th>
		                ...
		                <th data-options="field:'WPSYZ',width:100,align:'center'">客户名称</th>
